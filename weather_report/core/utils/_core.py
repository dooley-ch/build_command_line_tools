...
def find_data_folder(root: Path | str | None = None) -> Path | None:
    """
    This function finds and returns the location of the data folder
    :param root: The folder where to begin the search
    """
    return find_folder('data', root)


def find_database_folder(root: Path | str | None = None) -> Path | None:
    """
    This function finds and returns the location of the database folder
    :param root: The folder where to begin the search
    """
    return find_folder('database', root)
